...
export async function POST(req: Request) {
  try {
    ...
    prompt += `4. **Structure**: Use clean Markdown. You **MUST** use "###" for section headers (e.g., ### Day 1: The Refreshing Start). Use bold text for emphasis. Present the 7-day plan in a highly structured list format with clear bullet points for each meal.\n`;
    prompt += `5. **No Bulky Paragraphs**: Break every thought into a new line. Use a lot of white space.\n`;
    prompt += `6. **Strict Adherence**: Ensure every suggestion fits the ${leadData.diet} diet and respects the ${leadData.time} prep time.\n`;
    prompt += `7. **Visual Focus**: Describe the food in a way that feels visual and appetizing.\n`;
    prompt += `8. **Tone**: Be an expert guide who simplifies the complex. Make them feel empowered, not overwhelmed.\n`;
