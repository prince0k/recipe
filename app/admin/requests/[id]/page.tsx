        ...
        <div className="col-span-2">
          <Card className="h-full">
            ...
            <CardContent className="pt-6">
              <div className="bg-[#fcfaf7] text-[#2d2a26] p-8 md:p-16 rounded-3xl border border-[#e5e0d8] shadow-inner overflow-y-auto max-h-[850px]">
                <div className="prose prose-stone prose-lg md:prose-xl max-w-none 
                  prose-headings:text-[#1a1816] prose-headings:font-serif prose-headings:tracking-tight
                  prose-p:leading-relaxed prose-p:text-[#3d3a36]
                  prose-strong:text-[#1a1816] prose-strong:font-bold
                  prose-li:my-2">
