        ...
        <div className="col-span-2">
          <Card className="h-full">
            ...
            <CardContent className="pt-6">
              <div className="prose prose-sm max-w-none prose-green bg-gray-50 p-6 rounded-xl border border-gray-200 overflow-y-auto max-h-[800px]">
                {request.generatedContent ? (
                  <ReactMarkdown>{request.generatedContent}</ReactMarkdown>
                ) : (
                  <div className="text-gray-500 italic">No content generated.</div>
                )}
              </div>
            </CardContent>
          </Card>
