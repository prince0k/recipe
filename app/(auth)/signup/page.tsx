...
export default function SignupPage() {
  ...
  return (
    <>
      <h2 className="mt-2 text-center text-2xl font-bold font-serif text-gray-900 mb-6">
        ...
        <div className="flex items-start">
          <div className="flex items-center h-5">
            <input
              ...
              className="w-4 h-4 text-[#10b981] bg-gray-100 border-gray-300 rounded focus:ring-[#10b981]"
            />
          </div>
