      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="mt-12 border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex space-x-6 flex-shrink-0">
            <span className="text-text-muted opacity-40 cursor-not-allowed" title="Instagram - Coming Soon">
            ...
            <span className="text-text-muted opacity-40 cursor-not-allowed" title="Pinterest - Coming Soon">
