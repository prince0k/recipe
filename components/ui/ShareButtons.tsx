    ...
    <div className="flex flex-wrap items-center gap-3">
      ...
      {buttons.map((b) => (
        <a
          ...
          className={`flex items-center gap-1.5 border border-white/10 px-4 py-2 text-xs text-white/70 transition duration-300 cursor-pointer ${b.hoverClass}`}
        >
          {b.icon}
      ...
      <button
        onClick={copyLink}
        className="flex items-center gap-1.5 border border-white/10 px-4 py-2 text-xs text-white/70 transition duration-300 hover:bg-white/10 hover:border-white/30 hover:text-white cursor-pointer min-w-[100px]"
      >
